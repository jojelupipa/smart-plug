...
class PlugListWindow:
    """ Clase para gestionar la ventana de la lista de enchufes """
    ...
    def __init__(self):
        ...
        self.button_general = self.window.findChild(
            QtWidgets.QPushButton, "general_button"
        )
    ...
    def update_status(self):
        """ Comprueba la conexión al broker """
    ...
    def update_plug_list(self):
        """ Actualiza la lista de enchufes dinámicamente """
        plug_layout = self.window.findChild(
            QtWidgets.QVBoxLayout, "plugs_layout"
        )
    ...
    def plug_button(self, name="general"):
        """ Abrir la ventana de información de enchufe general """
